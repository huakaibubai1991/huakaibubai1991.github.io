...
<p style="font-size: 17px; text-align: justify;">I have broad research interests, including big data, data mining, applied machine learning, data analysis, data management, and their applications in various fields, particularly healthcare. In the future, I am interested in pursuing research topics that have a positive societal impact, particularly at the intersection of data science, AI, and psychology. I aim to develop intelligent soothing robots or machine learning models capable of better understanding and responding to human emotions.</p>
...
<body>
    <div class="container">
        ...
        <div class="text">
            <p><b>Senior Data Mining Engineer, Meitu (Beijing, CHN)</b><br> User Portrait Group, Data Intelligence Department<br>Mentors: Yan Meng, Zhao Yang</p>
        </div>
        <div class="date">
            <p>2019.06-Present</p>
        </div>
